...
LOCAL_C_INCLUDES += $(LOCAL_PATH)/libtommath 
LOCAL_C_INCLUDES += $(LOCAL_PATH)/libtomcrypt/src/headers
LOCAL_CFLAGS += -DDROPBEAR_SERVER -DANDROID_CHANGES  -DSFTPSERVER_PATH='"/data/data/berserker.android.apps.sshdroid/dropbear/sftp-server"'
# -DSFTPSERVER_PATH=/data/data/berserker.android.apps.sshdroid/dropbear/sftp-server

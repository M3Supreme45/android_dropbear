...
#define _PATH_SSH_PROGRAM "/data/data/berserker.android.apps.sshdroid/dropbear/ssh"
...
#define DEFAULT_PATH "/data/data/berserker.android.apps.sshdroid/dropbear:/usr/bin:/usr/sbin:/bin:/sbin:/system/sbin:/system/bin:/system/xbin:/system/xbin/bb:/data/local/bin"
